...
export function ZoneStep1Type({ form }: Step1TypeProps) {
  return (
          ...
          <FormItem>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              <div
                ...
                className={cn(
                  "group relative min-h-[120px] sm:min-h-[160px] p-4 sm:p-6 flex flex-row sm:flex-col items-start gap-4 sm:gap-3",
